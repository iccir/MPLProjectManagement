...
**no meeting notes (New Year's Day)**

---

# January 8, 2026

_attending_: @efiring, @tacaswell, @QuLogic, @ksunden, @timhoffm, @story645
...
- [x] [name=@story645] GSOC: backend API improvements
...
_attending_: @efiring, @ksunden, @QuLogic, @melissawm, @story645, @ayshih, @timhoffm
...
_attending_: @efiring, @melissawm, @anntzer, @story645, @ksunden, @tacaswell, @scottshambaugh, @timhoffm , @QuLogic
...
_attending_: @efiring @ksunden @QuLogic @tacaswell
