...
attendance:  @ksunden, @tacaswell, @efiring, @story645 , @melissawm, @esibinga, @stevezhang1999, @chahak13, @devRD, @ianthomas23
## Agenda
...
- @devRD: GSOC: relation operators, some spinup meetings
    - mathtext set of issues...
- @esibinga: starting next week with @melissawm and @story645
...
- @devRD: GSOC relational operator, PRs waiting on review...
