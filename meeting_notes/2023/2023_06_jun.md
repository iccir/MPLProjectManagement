...
attendance: @ksunden, @jklymak, @QuLogic, @efiring, @stevezhang1999, @melissawm, @oscargus, @devRD, @rcomer, @tacaswell, @story645
...
### GSOC:
- @devRD: operater in Mathtext.  Relational operators, and new ones.  @ksunden and @QuLogic mentoring.  @oscargus working on similar things.  Prioritization?
...
attendance: @efiring, @chahak13, @devRD, @greglucas, @ksunden, @brianholland, @ksunden, @qulogic, @tacaswell, @story645, @anntzer
...
## Agenda
_attending_: @oscargus @efiring @ksunden @QuLogic @greglucas @melissawm @devRD @esibinga @story645
