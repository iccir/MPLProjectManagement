...
## Agenda
- Meeting time- currently conflicts with @jklymak , @efiring teaching schedule
- releases
    - 3.2.0rc3,
    - 3.1.3
    - 2.2.5 (the last one!)
...
Consensus is alternative 3 (@timhoffm will take on)
...
- @story645 will review in the next couple of hours
- [x] follow up with @dorafc and @tacaswell on frontpage redesign timeline
