...
### [#15065] Drawstyle between
 ...
 - @tacaswell convinced that we should add new public API for this (a Line2D sub-class and `hist_draw()` method an proposed by Jody)
...
## Notes
@BrunoBeltran @GregLucas joined us.  (@anntzer, @story645 @tacaswell, @timhoffm, @qulogic)
### Introductions
