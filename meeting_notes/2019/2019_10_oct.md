    ...
    - Gridspec doesn’t need to have a parent (figure) because it can just be a pure layout engine← can be reusable 
        ...
        - gs.subplots() → now generate a subplot grid off this layout/spec
            ...
            - must create gridspec with explicit parent 
                ...
                - @anntzer - functions outside of pyplot shouldn’t invoke notion of current figure
                - preferred:
...
- 3.1.2 and 2.2.5 this week by @tacaswell
...
- 2.2.5 work
    ...
    - https://github.com/matplotlib/matplotlib/pull/15208
        - merged
        - but has terrible typo also in oginiral PR, @tacaswell will clean up
...
- @tacaswell still needs to do something about webagg
...
- https://github.com/matplotlib/matplotlib/pull/14501
    - merged, @tacaswell will fix up doc build in follow up if required
...
- https://github.com/matplotlib/matplotlib/issues/13619
    - @anntzer has already fixed this
- https://github.com/matplotlib/matplotlib/issues/14169
    - @tacaswell will look at
- moved rest to 3.2.1
...
- PyData NYC - submit stuff you think @tacaswell can’t do
...
- @tacaswell @dorafc @dopplershift @story645
- Nov 1st, 9 AM NYC time - let @story645 know if you want to attend remotely
