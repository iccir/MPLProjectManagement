...
- advertising:
    ...
    - post to our front page @tacaswell
...
- governance docs should move to docs/docs at some point
    ...
    - start by putting PRs into governance repository with: @story645
        - the roadmap
        - social guideline
        - named roles
- Roadmap
...
- someone needs to write conda w/ env instructions - @efiring
...
- conflict between simple examples that show one thing vs very nice plots that show many things
    - @story645 wants to run a sprint for a “chart types” sub-gallery
