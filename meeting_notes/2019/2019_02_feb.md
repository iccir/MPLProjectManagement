...
## Notes
- @tacaswell sent out email about release schedule

### Colorbar Norm #13234

- undoing @efiring design choice:
    ...
    - @jklymak made mock scalarmappable that can be deprecated
...
- @story645 will take lead on admin side
...
- OS/X backend used to be verified using cocoa app - @jklymak
...
- https://github.com/matplotlib/matplotlib/pull/11246 (needs some comments addressed by @tacaswell )
- https://github.com/matplotlib/matplotlib/issues/13258 last outstanding issue 

### Scatter Legend

- @efiring in charge of merging it
...
- @efiring - leave long names + short for alias
...
- there’s a shade=False flag  - 
    ...
    - ping @dstansby to release objections
...
### releases
@tacaswell and @ivanov  are having minor scheduling issues, “soon”

### 12839:

- accept the PR/override @anntzer concerns
...
- trust @anntzer + won’t discover edgecases until try to build wheels

### 9913

- not reproducible on mac/linux
- @anntzer cannot repro on windows+mpl3.0.3+qt5

### 12716

- can be merged? unclear what @dstansby intended
...
- @tacaswell has homework to address comments
