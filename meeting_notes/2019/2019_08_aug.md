...
- currently @tacaswell @dopplershift @efiring @mdboom can add people
...
- if you want in *now* email @tacaswell or @story645
...
- @tacaswell prefers 15029 over 14929
...
- there are deep issues with our current datetime handling
    ...
    - @efiring and @jklymak are excited about working with numpy to make this better!
...
@tacaswell @efiring @dopplershift @jklymak @ivanov @anntzer
...
- https://github.com/matplotlib/matplotlib/pull/15045
    ...
    - @anntzer has concerns we should be fixing this by setting the canvas size in `figure.set_size_inches` rather than patching up Qt, will leave a comment
- https://github.com/matplotlib/matplotlib/pull/14624
...
- https://github.com/matplotlib/matplotlib/pull/14521
    - @tacaswell was previously concerned about back-compat, but is swayed by @anntzer ‘s arguements
    - merged
- https://github.com/matplotlib/matplotlib/pull/14471
...
@tacaswell @dopplershift @anntzer

## Agenda

### Reschedule call

- not MWF to de-conflict with @efiring teaching schedule
...
- @dopplershift will come out a day early to work on documentation related grant
- @dopplershift , @story645 , @tacaswell , @dorafc will attend
