...
- [ ] Google Season of Docs-Numfocus needs ideas list @story645
    ...
    - [ ] Is there anyone in the project in charge of documentation? nope, @timhoffm -numpy + website,

## Notes

### google seasons of docs - (@story645 will write up)
...
- @efiring: what issues are DS folks having?
...
- @efiring suggest putting the flag on `Axis` rather than `Locator`
    - @tacaswell remembers talking about this and picking on the locator, but not why.
...
- @tacaswell agreed to be second GSOD mentor, willing to be replaced

### 8519: Closed figures linger in memory

- @efiring : we should prioritize this for 3.2
...
- make closing a figure making the figure dead-dead
    ...
    - 
    - [ ] @efiring will write this up to dev list
...
- [x] Documentation summit cc @dopplershift
- [x] 3.1rc work
- [x] mpl_cairo?
...
- announce to dev list this week + doodle poll
    - [ ] need to write clear charge @tacaswell
