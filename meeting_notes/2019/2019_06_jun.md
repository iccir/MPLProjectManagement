...
## Actions
- [ ] get sponsor button on repo(s) @tacaswell
- [ ] ask lawyer about cairo license compatibility with our license @tacaswell
- [x] write call to mailing list about OSX + cairo linking @anntzer
- [x] transfer mpl-cairo ownership to matplotlib org @anntzer
- [x] slide showing what mpl-cairo fixes (marker stamping in agg vs cairo) for Scipy Update - @anntzer

---

# June 10, 2019

@tacaswell @ivanov @efiring
