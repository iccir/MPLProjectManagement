...
- @efiring does not remember any discussion around this coming in
- @tacaswell I’m sold on dropping this behavior
- @efiring reasonable to leave to user to adjust larger markers
...
- @jklymak is working on making colorbars follow the size of the Axes they are attached to (not it’s container) so equal aspect Axes work correctly
- has issues with tight layout
- works with constrained layout

### doc summit - (@tacaswell write about/email explaining it)
...
- 3.1.0rc2
    ...
    - do final release when @tacaswell has time
