...
- https://github.com/matplotlib/matplotlib/pull/22560 (@oscargus has minor changes to make)
...
## Agenda
attending: @melissawm, @efiring, @timhoffm, @QuLogic, @jklymak, @tacaswell, @andrew-fennell, @story645
