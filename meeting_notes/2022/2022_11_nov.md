...
_attending_: @tacaswell @oscargus @efiring @story645 @timhoffm @kandersolar (Kevin Anderson) @ksunden @jklymak  @QuLogic @chahak13
...
_attending_: @efiring @story645 @ksunden @QuLogic @chahak13 @anntzer @greglucas
...
- @greglucas and @QuLogic have some experience with Meson
...
- @QuLogic has a test branch for _only_ the compiled extensions https://github.com/QuLogic/matplotlib/tree/meson

---

# November 17, 2022

_attending_: @efiring @story645 @ksunden @QuLogic @chahak13 @anntzer @greglucas, @noatamir @dopplershift, @melissawm
