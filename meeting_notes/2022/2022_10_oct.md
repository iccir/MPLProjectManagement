...
_attending_: Melissa (@melissawm), @greglucas, @noatamir, @efiring, @story645, @jklymak, @QuLogic, @timhoffm
...
_attending_: @oscargus, @story645, @jklymak, @QuLogic, @ianthomas23, @ksunden, @efiring, @melissawm
...
- @oscargus to open Issue solicitling standard link...
...
- larger scale issues co-ordinating group work/ work for RSEs
    - @QuLogic @ksunden @tacaswell will start summarizing work in Gitter...
    - Weekly report: 
