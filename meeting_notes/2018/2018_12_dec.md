...
- checking for membership in class and not documenting @efiring
...
- write a 2 page Work Plan for sprint -@story645 by end of January
...
- Boulder as location  @dopplershift
...
**TODO: ALL THE GOVERNANCE THINGS - @tacaswell @efiring @dopplershift **
...
- QT options editor library generates menu based on  second entry?? (@anntzer ?)
  - string - 
  - int - 
...
- end of lining hangouts in 2020, need functional replacement + roll out of new link (cc @tacaswell )
...
- 12678: Properly set tz for YearLocator @jklymak
...
- [ ] 12678: Properly set tz for YearLocator @jklymak  https://github.com/matplotlib/matplotlib/pull/12678
