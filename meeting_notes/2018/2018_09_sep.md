...
- Cartopy GeoAxes
  ...
  - @anntzer and @tacaswell looking at it.
...
- tick locators:
  ...
  - @jklymak ‘s PR moves the ‘pixel’ level clipping to the Axis object rather than the the locator
...
- Proposal: 
  ...
  - @tacaswell is on board with this.
