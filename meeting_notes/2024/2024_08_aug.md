...
_attending_: @efiring, @tacaswell, @ksunden, @QuLogic, @trygvrad, @timhoffm, @ianthomas23, @story645
...
_attending_: @greglucas, @story645, @tacaswell, @ksunden, @QuLogic, @efiring, @trygvrad
...
#### new pipeline
 - has PR to @trygvrad's branch to adjust inheretance so to avoid breaking user code
