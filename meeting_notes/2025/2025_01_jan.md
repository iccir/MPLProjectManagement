...
_attending_: @greglucas, @efiring, @story645, @tacaswell, @rcomer, @ksunden, @efiring, @timhoffm
...
_attending_: @tacaswell @timhoffm @efiring @ksunden @QuLogic @story645
...
_attending_: @tacaswell @pawjast @efiring @ksunden @QuLogic @story645
## Agenda
### Old business
- [x] RSE Updates
- [x] NASA status
