...
_attending_: @tacaswell, @ksunden, @QuLogic, @story645, @timhoffm, @trygvrad
...
### RSE updates
 ...
 - Elliott
     ...
     - @anntzer is reviewing / updating to keep work moving
...
_attending_: @tacaswell, @QuLogic, @efiring, @ksunden, @story645, @anntzer
