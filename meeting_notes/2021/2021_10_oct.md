...
- cut bad commits:
    ...
    - @greglucas and @anntzer are going to investigate tech to flag bad commits...
...
- mpl-data status
    ...
    - @QuLogic will write API note for down-stream packagers highlighting that matplotlibrc is now a read/parsed at run-time file (not just docs)
- docs re-org
...
- https://github.com/matplotlib/mpl-brochure-site/pull/21
    - binder: 
        ...
        - startup slow.
        - ACTION: talk to binder folks. @story645
