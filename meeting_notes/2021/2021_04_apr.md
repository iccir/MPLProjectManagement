...
- SVG has too many edge cases and concerns about performance to switch to it by deault.  We tried this several years ago and it went badly (was reverted)
 - @jklymak has a proof of principle that works, will work with sphinx-gallery folks to move the logic there.
...
- applicants by two weeks:
    ...
    - Jounni interested in helping w/ review for @tacaswell @anntzer: text/latex
    - pytest project?
        - no applicant
...
### polar PRs
- @anntzer adding some of the recent polar PRs to 3.4.2
